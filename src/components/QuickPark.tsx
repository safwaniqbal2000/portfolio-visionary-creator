...
const QuickPark = () => {
  ...
  return <section id="quick-park" ref={ref as React.RefObject<HTMLDivElement>} className="py-24 px-4 md:px-8 bg-accent/5">
          ...
          <div className="space-y-8">
            <div className="bg-card rounded-xl border border-border/50 overflow-hidden">
              <div className="aspect-video bg-accent">
                <img alt="Quick Park Project Preview" className="w-full h-full object-cover" src="/lovable-uploads/beb16a9e-ae4a-454d-954f-9150a6df5dae.jpg" />
              </div>
              <div className="p-6">
